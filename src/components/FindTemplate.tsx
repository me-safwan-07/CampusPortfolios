...
export function FindTemplate() {
  return (
    <div className="flex flex-col items-center justify-center mt-12 pt-12 sm:p-3 lg:p-8">
      <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl dark:text-white text-black font-bold mb-4 sm:mb-6 text-center">
